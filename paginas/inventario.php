...
<head>
    ...
    <link rel="stylesheet" href="../estilos/styleInventario.css">
...
<body>
    ...
    <div class="container">
        ...
        <div class="content">
            <!-- Contenedor Superior -->
            <div class="contenedor-superior w-2">
                <h3>Inventario</h3>
            </div>

                <br>

           <!-- Contenedor Inferior con tres columnas -->
            <div class="row row-alto-restante">
                <div class="col contenedor-izquierda">
                    <h3>Categoria</h3>
                    <br>
                    <div class="img-container">
                        <a href="categorias.php"> 
                            <img src="../imagenes/categorias-inventario.png" alt="categoriasInventario">
                        </a>
                    </div>
                </div>

                <div class="col contenedor-central">
                    <h3>Listado</h3>
                    <br>
                    <div class="img-container2">
                        <a href="listadoInventario.php">
                            <img src="../imagenes/listado-inventario.png" alt="ListadoInventario">
                        </a>
                    </div>
                </div>
                ...
                <div class="col contenedor-derecha">
                    ...
                    <div class="img-container3">
                        <a href="">
                            <img src="../imagenes/historial-inventario.png" alt="Historialinventario">
                        </a>
                    </div>
                </div>
            </div>
    ...
    <script src="../javaScrip/scripInventario.js"></script>
