...
<body>
        ...
        <div class="contenido">
            <div class="superior">
                <div class="izquierda-superior">
                    <a href="../paginas/categorias.php" class="retroceder"><</a>
                    <h1 id="contenidoRetroceso" class="contenidoRetroceso"></h1>
                </div>
            </div>
            <div class="contenedor-inferior">
                <div class="izquierda ">
                    <div class="imagenProducto" id="imagenProducto"></div>
                </div>
                <div class="derecha">
                    <div class="descripcionProducto" id="descripcionProducto"></div>

                    <div class="informacion">
                        <h6 class="precioProducto" id="precioProducto"></h6>
                        <h6 class="cantidadProducto" id="cantidadProducto"></h6>
                    </div>
    ...
    <script src="../javaScrip/scripProducto.js"></script>
